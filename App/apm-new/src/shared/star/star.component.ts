...
export class StarComponent implements OnChanges, OnInit {
  ...
  @Output("updeteRating") starRating: EventEmitter<number> = new EventEmitter<number>()
  cropWidth: number = 0;
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    this.starStatus.emit(`star component set with OnChange for rating ${this.rating}`)
  }
